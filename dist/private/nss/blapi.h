...
** output.
*/
extern SECStatus Ed25519_NewKey(ECParams *ecParams, ECPrivateKey **privKey);
...
** Uses Hacl* code.
*/
extern SECStatus Ed25519_SignDigest(ECPrivateKey *key, SECItem *signature,
                                          const SECItem *msg);
...
*/
extern SECStatus Ed25519_VerifyDigest(ECPublicKey *key, const SECItem *signature,
                                        const SECItem *msg);
